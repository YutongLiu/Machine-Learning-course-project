...
To evaluate the out of sample error, we predict the outcome with  cross-validation data.
...
As the confusion matrix shows, the first model identifies class A and the third one identifies class D and E better. The accuracy of second model is better than another two models.
